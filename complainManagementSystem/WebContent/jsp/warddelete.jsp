...
<div class="row">
      ...
      st.executeUpdate("delete from complains where WARDS_ID ="+request.getParameter("id"));
     ResultSet res = st.executeQuery("select WARDS_MEM_ID,LOGIN_ID from wardsmemberregistration where WARDS_ID ="+request.getParameter("id"));
     int wardmemberID = 0;
     int loginid = 0;
     while(res.next()){
    	 wardmemberID = res.getInt("WARDS_MEM_ID");
    	 loginid = res.getInt("LOGIN_ID");
     }
     st.executeUpdate("delete from wardsmemberregistration where WARDS_ID ="+request.getParameter("id"));
     st.executeUpdate("delete from logindetails where LOGIN_ID ="+loginid);
     st.executeUpdate("delete from wards where WARDS_ID ="+request.getParameter("id"));
      ...
      %>
        ...
        while(rs.next())
            {%>
        	<tr>
           <td><%=rs.getInt(1)%> &nbsp;&nbsp;<td><%=rs.getString(2)%> &nbsp;&nbsp;</td><td><a href="/complainManagementSystem/jsp/wardedit.jsp?id=<%= rs.getInt(1)%>">EDIT </a>  &nbsp;&nbsp;</td><td><a href="warddelete.jsp?id=<%= rs.getInt(1)%>">DELETE </a>&nbsp;&nbsp;</td> 
            </tr>
