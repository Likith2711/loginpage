...
<div class="row">
      ...
      int loginIDS = 0;
     ResultSet resss = st3.executeQuery("select LOGIN_ID from  wardsmemberregistration where WARDS_MEM_ID ="+request.getParameter("id"));
     while(resss.next()){
    	 loginIDS = resss.getInt("LOGIN_ID");
     }
     st3.executeUpdate("DELETE FROM `wardsmemberregistration`  WHERE `WARDS_MEM_ID` ="+request.getParameter("id"));
     st3.executeUpdate("DELETE FROM `logindetails`  WHERE `LOGIN_ID` ="+loginIDS);
