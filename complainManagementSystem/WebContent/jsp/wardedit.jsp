...
<div class="row">
      ...
      %>
        ...
        while(rs.next())
            {%>
        	<tr>
           <td><%=rs.getInt(1)%> &nbsp;&nbsp;<td><%=rs.getString(2)%> &nbsp;&nbsp;</td><td>EDIT &nbsp;&nbsp;</td><td><a href="warddelete.jsp?id=<%= rs.getInt(1)%>">DELETE </a>&nbsp;&nbsp;</td> 
            </tr>
      ...
      %>
          	               ...
          	               <% Connection cone=dbc.getConnection();
      Statement ste=cone.createStatement();
      ResultSet rse=ste.executeQuery("SELECT * FROM wards where WARDS_ID ="+request.getParameter("id"));
      %>
 <%
        while(rse.next())
            {%>
          ...
          <div class="col-sm-6">
            <section class="panel">
              ...
              <input type="hidden" name="id" value=<%=rse.getInt(1) %>>
                    <label for="inputEmail1" class="col-lg-2 control-label">Ward Name</label>
                    <div class="col-lg-10">
                      <input type="text" class="form-control" id="inputEmail1" placeholder="Ward Name" name="ward" value=<%= rse.getString(2) %>>
                    </div>
                  </div>
                  <div class="form-group">
