...
<body>
 <section id="container" class="">
   <header class="header dark-bg">
    <!--logo start-->
      <a href="" class="logo">Online Municipal Complaint System<span class="lite"></span></a>
          ...
          <div class="col-lg-9 col-md-12">
            <div class="panel panel-default">
              <div class="panel-heading">
                <h2><i class="fa fa-flag-o red"></i><strong>Complaint Request</strong></h2>
                 </div>
              <div class="panel-body">
              
              <form class="form-horizontal" action="./complaintrequest.do" method="post">
               <div class="form-group">
                        <label class="control-label col-lg-2" for="cType"> Complaint Type</label>
                        <div class="col-lg-6">
                         <select class="form-control input-lg m-bot15" id="cType" name="cType">
               ...
               <div class="form-group">
                        ...
                        <div class="col-lg-6">
                          <input type="text" class="form-control" id="cdis" name="cdis">
                        </div>
                      </div>
                      <div class="form-group">
...
function myFunction(){
	var cdis = document.getElementById("cdis").value;
var address = document.getElementById("address").value;
var cd = document.getElementById("cd").value;
if(cdis == ""){
	  alert("Complaint Description must be filled out");
     return false;
...
if(cd == ""){
	  alert("Created Date must be filled out");
     return false;
