...
<div class="row">
      ...
      %>
        ...
        while(rs2.next())
            {%>
        	<tr>
           <td><%=rs2.getString(1)%> &nbsp;&nbsp;</td> <td><%=rs2.getString(2)%> &nbsp;&nbsp;</td> <td><%=rs2.getString(3)%> &nbsp;&nbsp;</td> <td><%=rs2.getString(4)%> &nbsp;&nbsp;</td><td><%=rs2.getString(6)%> &nbsp;&nbsp;</td><td><%=rs2.getString(7)%> &nbsp;&nbsp;</td><td><%=rs2.getString(8)%> &nbsp;&nbsp;</td><td><a href="/complainManagementSystem/jsp/complaintAccept.jsp?id=<%= rs2.getInt(5)%>">ACCEPT </a>&nbsp;&nbsp;</td> <td><a href="/complainManagementSystem/jsp/complaintReject.jsp?id=<%= rs2.getInt(5)%>">REJECT </a>&nbsp;&nbsp;</td> 
 <td><a href="/complainManagementSystem/jsp/complaintclose.jsp?id=<%= rs2.getInt(5)%>">CLOSE </a>&nbsp;&nbsp;</td>            </tr>
